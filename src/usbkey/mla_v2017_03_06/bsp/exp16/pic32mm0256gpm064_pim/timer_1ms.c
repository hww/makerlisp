...
/* Run at 960 because it's divisible by 12 */
#define CLOCK_DIVIDER TIMER_PRESCALER_1
#define PR1_SETTING (SYSTEM_PERIPHERAL_CLOCK/960/1)
...
/****************************************************************************
  ...
  Remarks:
    None
  ***************************************************************************/
void __attribute__ ( ( vector(_TIMER_1_VECTOR) , interrupt(IPL1SOFT) ) ) T1Interrupt ( void )
{
    uint8_t i;
